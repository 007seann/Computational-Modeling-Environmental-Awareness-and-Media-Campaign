...
<experiments>
  ...
  <experiment name="experiment-main-High_by_sean" repetitions="10" runMetricsEveryStep="true">
    <setup>Setup</setup>
    <go>Begin</go>
  ...
  <experiment name="experiment-main-Medium_by_sean" repetitions="10" runMetricsEveryStep="true">
    <setup>Setup</setup>
    <go>Begin</go>
    <timeLimit steps="1250"/>
    <metric>eco_level_pop</metric>
  ...
  <experiment name="experiment-main-Low_by_sean" repetitions="10" runMetricsEveryStep="true">
    <setup>Setup</setup>
    <go>Begin</go>
    <timeLimit steps="1250"/>
    <metric>eco_level_pop</metric>
  ...
  <experiment name="experiment-main-All_by_sean" repetitions="10" runMetricsEveryStep="true">
    <setup>Setup</setup>
    <go>Begin</go>
    <timeLimit steps="1250"/>
    <metric>eco_level_pop</metric>
  ...
  <experiment name="experiment-main-None_by_sean" repetitions="10" runMetricsEveryStep="true">
    <setup>Setup</setup>
    <go>Begin</go>
    <timeLimit steps="1250"/>
    <metric>eco_level_pop</metric>
